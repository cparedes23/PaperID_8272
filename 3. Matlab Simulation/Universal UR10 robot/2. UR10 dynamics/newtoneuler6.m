...
% TAU = NEWTONEULER6(Q, QP, QPP, G, M7, IEXTER) calculates the vector
% 6x1 vector of input torques/forces to the joints. Q the vector
% 6x1 vector of joint coordinates. QP is the vector 6x1 representing
% the velocity of each joint. QPP is the 6x1 vector representing
% the acceleration of each joint. G is the value of gravity (m/s^2).
% M7 is the mass of the external load (kg) carried by the robot arm.
