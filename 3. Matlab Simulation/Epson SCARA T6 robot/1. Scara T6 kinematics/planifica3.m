% PLANIFICA3 Path planning
% MAT_Q = PLANIFICA3(P1, P2, N, S, A, CODO, NPUNTOS) Perform a 
...
function mat_q = planifica3(p1, p2, n, s, a, codo, npuntos)
...
for i=0:(npuntos+1)
    ...
    q = inversekinematicscara(T,codo);
    mat_q(:,i+1) = q;
end
