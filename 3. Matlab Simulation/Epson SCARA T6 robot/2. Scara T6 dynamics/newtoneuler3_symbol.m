...
% TAU = NEWTONEULER4(Q, QP, QPP, G, M5, IEXTER) Vector of Torques
% 3x1 of input torques/forces to the joints.

clc,clear all
syms q1 q2 q3 qp1 qp2 qp3 qpp1 qpp2 qpp3  mexter Iexter 
assume(q1,'real')
assume(q2,'real')
assume(q3,'real')
assume(qp1,'real')
...
r30vp3 = ri0vpi_p(r32, r20vp2, r30wp3, r30w3, r30p3, qp3, qpp3);
...
t_3 = simplify(f_p(r32, r30f3a, qp3, b3));
